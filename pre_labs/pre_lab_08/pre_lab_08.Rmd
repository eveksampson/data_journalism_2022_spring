...
**Answer**
The counties that saw their median income fall were: Somerset County and Caroline County. The change was not outside the margins of error for either.
```{r}
md10 %>%
