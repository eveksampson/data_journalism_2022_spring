...
**Answer** The city names all have different cases (some uppercase, some lowercase, some mixed), they also have different forms of spelling or writing the same city
...
**Answer** It merged some of the names (like PHOENIX to Phoenix and WESTMINSTER to Westminster) but it did not fix everything.
...
**Answer**  It changed ABELL to Abell, aberdeen to Aberdeen, and ABERDEEN to Aberdeen.
...
**Answer** There is not a major change, though it did capitalize Abigdon.
