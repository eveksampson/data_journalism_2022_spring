...
**Answer** https://datawrapper.dwcdn.net/l9h9D/1/
...
**Answer** This shows the number of loans per county.
...
**Answer** This filters out counties with less than 6 loans. 
...
**Answer** This combines the state code and county code. 
...
**Answer** This now has counties with counts and fips codes. 
...
**Answer** This zooms in on just Maryland.
...
**Answer** First, we changed the fips title to the county name for better understanding. We also changed the count format so that it shows the number in thousands with commas. We also included "approved loans" at the end to make it better.
...
**Answer** https://datawrapper.dwcdn.net/L4DcA/1/
