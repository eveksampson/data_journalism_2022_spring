...
**Answer** This is an image screenshot of a bung of files labeled "Hospitals" in various forms. All are last modified Feb 4 at 3:29pm. 
...
**Answer** this spits out what looks like a dataframe with 7,581 rows and 33 columns. It also includes location points (geometry column) 
...
**Answer** This looks somewhat like a dataframe but formatted differently in the space below. It includes geometry points (locations) for the 72 Maryland hospitals. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This breaks the hospitals down by type - General acute care, Psychiatric, Military, Chronic Disease, etc - and summarizes how many there are. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This filters for ONLY on the General Acute Care hospitals. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This takes the hospital data from the last part and plots it on a chart/map looking thing. There is no overlay. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This calls the counties including their geographic data/elements. (Geometry columns for all counties)
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This filters only the Maryland counties by using the state FIPS code
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This plots a recognizable Maryland map by county. There is a small issue - it fills in the bay areas.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** this plots the location of acute care hospitals on the map of Maryland by county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This changes the color of the dots by the number of beds. The darker the dot, the fewer the beds. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This reloads the same dataframe we were working with.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This gives us the total beds per county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This gives us county population data so we can calculate per capita rates.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This shows that the census data can also give us shapes/geometry for maps. This gives us a dataframe with county, population and geometry.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This is the two dataframes - total beds per county and county population. The two dataframes look very different.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This cleans the maryland_county_population table to rename, uppercase and remove the word "county." It also makes sure there is nothing extra - including spaces. It leaves us with three columns. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This joins the two dataframes. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This cleans more - if a place has no beds, it now shows "0" instead of "NA"
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This joings, calculates total beds and arranges it to see the most beds per 100k people. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This gives us a chloropleth map of Maryland by county showing what areas have the highest acute care beds per capita. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This changes the color from blue to purples/warmer tones. Option is "magma" instead of a minimal theme. 
...
**Answer** Southern Maryland has fewer acute care beds than other areas like Western Maryland or the Eastern shore. There are two notable exceptions, including Baltimore city. I am not sure why this is - maybe some people in the "DC suburb" are diverted to DC hospitals? 
