...
**Answer** The code is summarizing all of the data by Project County Name, then summarizing the number of loans in each county. Then, it sorts in descending order and shows the first 10 results. 
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** a graph of the total loans in each of the selected counties.
...
**Answer** this puts the counties in ascending order so it appears more visually pleasing. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** this flips the axes and makes the names more readable. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** the grey background is now white (it gets rid of the color of the background). You can see the lines a little more clearly. 
...
**Answer** It gives the chart some color (blue) with white lines.
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** There is now a bold title, the axes are labeled and there is a source caption. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** this shows a dataset of total loans and date_approved. It is not yet in graph form.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** this is a line graph showing how many loans were approved over time. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** the x axis is now broken up into 1 month increments. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** the labels on the x-axis have been rotated 45 degrees to make them readable. 
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
