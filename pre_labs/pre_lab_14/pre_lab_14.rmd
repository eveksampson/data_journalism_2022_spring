...
**Answer** It outputs a HUGE dataframe of 152,584 tweets with usernames, dates created, branches and states of the politicians, etc. 
...
**Answer** it only shows the unique instance of each thing in the list. 
...
**Answer** This is a HUGE list of unique words out of set of tweets. 5.4 million rows long. 
...
**Answer** The first bunch of words was prepositions and "junk" like "the, and, of, etc."
...
**Answer** Much less junk, much more interesting- COVID, covid19, pandemic, vaccine and health. 
...
**Answer** This is similar - COVID, 19 - lots of similar words for both years BUT 2021 we see "vaccine" come.
```{r}
unique_words_2020 %>%
  anti_join(stop_words) %>%
  group_by(word) %>%
...
**Task** Run the following code and describe the results.
**Answer** This give us a bunch two-word phrases such as covid 19, 19 pandemic, health care, public health, town hall. The most common bigram was covid 19
...
**Task** Run the following code and describe the results.
**Answer** Lots of COVID phrases again had healthcare in 2020 but now everyone is talking about vaccines as well. 
...
**Task** Run the following code and describe the results.
**Answer** Members of congress tweeted about the pandemic, but it seems like Democrats tweeted about COVID 19 more. 
...
**Task** Run the following code and describe the results.
**Answer** Lots of "president trump, illigal immigrants, joe biden, covid-19" in 2021, "god bless, president trump, nursing homes, covid relief," in 2020
...
**Answer** The 2020 datafram has relief as a positive, crisis as a negative, amongst many others. The 2021 has a similar output. 
