...
#q1_sentence <- paste("The most recent police incident was on ", format(latest_date$date, format="%B %d"), " ", direction, " by ", changetext, " percent compared to the week before", sep="")
