...
```{r}
md_vaccines <- st_read("https://raw.githubusercontent.com/state-of-maryland/VaccineCSVs/master/Vax_ZIP_CODE_FirstSecondSingle_Totals_Raw.csv") %>%
  clean_names() %>%
  mutate(date = today()) %>%
...
#maryland_zips <- md_vaccines %>% filter()
