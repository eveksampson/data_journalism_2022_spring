...
A1: The five cities with the largest number of loans are as follows: 1)Charleston with 2,802 loans, 2)South Charleston with 478 loans, 3)Saint Albans with 296 loans, 4)Dunbar with 162 loans, and 5)Nitro with 140 loans. 
```{r}
...
A2: 25301 had the highest amount of total loans by dollar value at 160,721,321 dollars. This zip code is located right in the middle of the state and has a median house price of $187,400. JACKSON KELLY PLLC got the largest loan in that zip code at 5,068,472 dollars. 5,126,618.6 dollars was the forgiveness amount, meaning the entire loan was forgiven. The forgiveness amount is larger because it includes the interest accrued. 




```{r}
wv_high_zip <- wv_ppp_loans %>%
...
A3: West Virginia Representative Carol Miller's husband, Paul Logus, owns five car dealerships. DM Motors, Dutch Miller Chevrolet, Dutch Miller of Charleston, Dutch Miller of Charlotte, and Dutch Miller Subaru. In total, they recieved 3,105,300 dollars in PPP loans. The government forgave 3,140,471, which includes the interest accrued. The government forgave 101.13% of the loans. When the CARES was introduced to the House, she voted in favor of it. 


```{r}

Carol_Miller_spouse <- wv_ppp_loans %>%
  ...
  summarise(amount = sum(forgiveness_amount))
