...
mutate(
  ...
  arrange(desc(jobs_retained_category))
```
...
**A5** 10 applicants listed 500 jobs retained. J. Austin Heating & Cooling Inc. had earliest approval date, which was April 8, 2020. 

```{r}
applicant_max_jobs_retained <- west_virginia_ppp %>% filter(jobs_retained == 500)
