...
**A2.** The pattern is similar to the one in question 1 - it's like a diagonal line bisecting West Virginia at an angle. The dots cluster around that line, similar to how the loans wear greater above. There definitely seems to be some kind of relationship or correlation - lots of mines clustered around the bottom, just like the loans.. 
...
**A3.** There are hardly any mines in that county - maybe 2 on the fringe. Most of the other counties do show some kind of trend. 
```{r}
ggplot() + 
  geom_sf(data=joined_wv, aes(fill=per_100k))+ 
  geom_sf(data=question_2) +
...
* What single company accounts for the biggest chunk of the total loan amount? Greenbriar Hotel Corporation at 
...
* What single company accounts for the biggest chunk of the total loan amount? Hall Drilling, Inc. at $6,866,600.0
* What specific industry are they in, based on their 6-digit NAICS code? Look them up on the web. What services do they provide? Their NAICS code is 213111 - Drilling, Oil, Gas and Wells. According to their website, they provide oil and well drilling. (https://www.halldrilling.com/)
* How many jobs did they save, according to the data? The data says they retained 387 jobs.
* What's your hypothesis for why a company in their specific industry would need to seek a PPP loan during the pandemic? 

I honestly didn't think it was odd that a business in that industry would seek a PPP loan until the question was asked. My hypothesis is that some of their contracts were halted or postponed due to COVID restrictions. If they weren't considered essential workers, they may not have been allowed to work. At Hunter Army Airfield (where I worked at the start of the pandemic), some of our major construction projects were postponed indefinitely. Perhaps the same happened here? Or maybe fewer people were asking for personal well drilling? Maybe they are not considered essential? I would like to know more before making a judgement on whether or not they should have been granted a PPP loan.
