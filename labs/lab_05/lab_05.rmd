...
**A1.** 126 E Burke St has the most loans with 6 loans. The business names at that address are 	
DREW HOLDINGS LLC, BRIX27, LLC, ABRAHAM ASHTON, HUB CO-OP LLC, HUB CO-OP, LLC, and RONIN PROPERTIES LLC.
...
wv_zip_25401_loans <-read_csv("data/zip-25401-loan-sample-csv.csv")

street_address_most_loans <- wv_zip_25401_loans %>%
...
business_names <-wv_zip_25401_loans %>%
  filter(cleaned_address == "126 E Burke St")
...
**A2.** It does not seem suspicious that these businesses all use this address. 126 E Burke St., Martinsburg WV is known as "The Hub," which is an office space rental agency according to Googlemaps. I researched each business individually to make sure they were not some kind of business that would not be able to rent office space (like a farm). Drew Holdings LLC is a real estate management company that listed 1 employee. Brix 27 is a wine bar but whose registered address is 126 E Burke but whose physical location is elsewhere in WV. It is interesting that according to Open Corporates, DREW HOLDINGS LLC is a member BRIX27 LLC. I'm not sure exactly what that means. ABRAHAM ASHTON LLC is also a member of BRIX27 LLC. The HUB LLC (which seems to be a duplicate) is the name of the office space company. Ronin Properties, LLC is another real estate organization registered to that address. I'm not sure how all of these relate to each other, but it does not seem suspicious to me.
...
**A3.** Martinsburg had the highest number of loans with 1166 loans. "Full service resteraunts" had more loans than any other industry title with 50 loans.
...
clean_berkeley_loans <-read_csv("data/berkeley-loans-csv.csv")
  
answer_1 <- clean_berkeley_loans %>%
...
**A4.** My best hypotheses are as follows: 1) the full-service restaraunt industry was hit very hard by COVID because people did not want to eat out in confined spaces, and 2) people were unable to afford "luxuries" like dining out because many people also lost jobs. 
...
**A5.** COTTLE CHRISTI L LLC had the highest approved load at 280,434.00 dollars. It was approved 2021-02-17. The data says 94 jobs were retained. There is a difference between the name on the data and the name customers may know the business by. According to the West Virginia Secretary of State website, this organization has "DBAs" - Doing Business As - names of Kitzies's Cafe, Kitzie's Cafe II, Kitzie's of Inwood, Kitzie's of Spring Mills, Kitzie's Resturaunt and Lounge and Riverbend Bar & Grill. At one point, it had 6 locations. Now, it only has 4.Two of these places are closed; Kitzie's Cafe II closed in 2018 and Kitzie's of Inwood closed May 2020, in the early months of the pandemic before it got the loan. 
