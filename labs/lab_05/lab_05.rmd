...
**A3.** Martinsburg had the highest number of loans with 142 loans. "Full service resteraunts" had more loans than any other industry title.

```{r}
berkeley_loans <- wv_zip_25401_loans %>%
