...
```{r}
maryland_ppp_with_naics_and_ZCTA <- maryland_ppp_with_naics %>% left_join(maryland_zcta, by=c("zip5"="ZCTA5N"))
...
**A1**  Taxi Service (7363 loans), Beauty Salons (7275 loans), Full Service Restaurants (5490 loans), Offices of Real Estate Agents and Brokers (4443 loans), and All Other Personal Services (3956 loans).
...
**A2** The top industries are Taxi Services (7361 loans) and Beauty Salons (7169 loans). See loans_under_150k for full list. 

```{r}
loan_under_150k <-
  maryland_ppp_with_naics_and_ZCTA %>% filter(amount < 150000)  %>%
    group_by(title)  %>%
    summarise(
    naics_count = n()) %>%
arrange(desc(naics_count))
...
**A3** 20601 had the largest sum of PPP loans with 4,616,0664.5 dollars in loans and 866 loans. 
...
**A4** 20850 had the largest sum of loans where the reported race of the applicant was "Asian," with 28,994,798 dollars in loans. 20850 had 240 loans. The percentage of non-Hispanic Asian population for that zip is 23.5 percent.
...
**A5** This zip code is Rockville, MD in Montgomery County. A quick demographic search based on the zipcode showed very simiar percentages of the Asain population (https://www.unitedstateszipcodes.org/20850/). Many different scenarios may account for the difference in population versus loans. Asian business owners may have sought alternative means to finance pandemic struggles as opposed to utilizing government help. There may be fewer Asian business owners who sought loans or who needed them. There is not enough information to make a conclusion. 
...
**A6** There are three zip codes where an applicant is listed as Asian but there does not appear to be an Asian population. 21031 has 6 loans with a sum of 6,819,563 dollars. 21240 has 3 loans with a sum of 35,867 dollars. 20701 has 4 loans with a sum of 75,170.5 dollars. Perhaps the owners of these businesses live outside of the zip code where the business is located. They might commute to work.
...
**A7** 44 industries have exactly one loan in the data. I think I would choose to write about the fur bearing animal and rabbit production because it seems newsworthy to me. It is interesting  that an industry repeatedly shown to be unethical and abusive gets government funding. I understand that some may disagree (and obviously I am biased) but I think it would make some people raise eyebrows as most fur-raising industries have disappeared. I would also be interested in exploring the small arms manufacturing industry loan.
