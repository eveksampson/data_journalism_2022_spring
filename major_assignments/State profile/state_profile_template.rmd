...
**A2.** 
```{r}
#number of loans per capita by county? Number of loans per capita by zip?
...
la_pop_county <- get_acs(geography = "county", 
  ...
  rename(project_county_name=NAME) %>%
      ...
      mutate(project_county_name = str_replace_all(project_county_name, "Saint","St."))
